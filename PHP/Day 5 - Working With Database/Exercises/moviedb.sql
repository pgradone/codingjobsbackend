...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 01, 2020 at 01:55 PM
...
(7, 'Frank Darabont', 'France', 1959, 'https://m.media-amazon.com/images/M/MV5BNjk0MTkxNzQwOF5BMl5BanBnXkFtZTcwODM5OTMwNA@@._V1_.jpg');
...
INSERT INTO `movies` (`id`, `title`, `release_year`, `views`, `director_id`, `poster`) VALUES
...
(10, 'Raiders of the Lost Ark', 1981, 60000040, 5, 'https://vignette.wikia.nocookie.net/filmguide/images/1/11/Raiders_of_the_lost_ark_movie_poster.jpg/revision/latest?cb=20191211141747'),
(14, 'The Shawshank Redemption', 1994, 30000, 7, 'https://m.media-amazon.com/images/M/MV5BMDFkYTc0MGEtZmNhMC00ZDIzLWFmNTEtODM1ZmRlYWMwMWFmXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg');
...
(2, 'pgradone', 'pgradone@gmail.com', '$2y$10$H4QUAGqQiBqEhBrOfoQuM.0YiE0jVekv5Hk4z1pi37nJei6a82h.y'),
(3, 'brad', 'brad@brad.com', '$2y$10$dAnb04Y/G.Rsd3Z/QBmQquph3JnFQ4z06onMin0BuD07ZmvgyfXmm'),
(4, 'avy', 'avy@avy.com', '$2y$10$wHLfhSQscShp5kXx3J1N7uLgcEGCXqmcT6IkuLPyRoVwG7AwAvlmO');
