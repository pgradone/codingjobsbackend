...
$character['my1stcharacter'] = [
  ...
  $character['my2ndcharacter'] = [
    ...
    echo '<ul>';
    echo '<li>' . $character['my1stcharacter']['lastname'] . '</li>';
    echo '<li>' . $character['my2ndcharacter']['characteristics']['stamina'] . '</li>';
    echo '</ul>';
    echo '</pre>' ;
?>  

<ul>
  <li><?php echo $character['my1stcharacter']['lastname'] ?></li>
  <li><?php echo $character['my2ndcharacter']['characteristics']['stamina'] ?> </li>
</ul>
</html>
